...
/*
    ...
    - অবজেক্ট হলো ইউজার-ডিফাইন্ড ক্লাসের উদাহরণ যা মান (value), ফাংশন, এবং ডেটা প্রসেসিং লজিক ধারণ করে।
    - অবজেক্ট তার ক্লাস থেকে প্রোপার্টি এবং আচরণ (behavior) গ্রহণ করে, তবে প্রতিটি অবজেক্টের প্রোপার্টি মান আলাদা হয়।
    - অবজেক্ট স্পষ্টভাবে new কীওয়ার্ড ব্যবহার করে তৈরি করা হয়।
